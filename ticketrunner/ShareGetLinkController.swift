...
class ShareGetLinkController: ScrollController {
    ...
    override func setupViews() {
        ...
        promoteShareLinkView.anchor(top: stepView.bottomAnchor, left: scrollContainerView.leftAnchor, bottom: nil, right: scrollContainerView.rightAnchor, paddingTop: 8, paddingLeft: 8, paddingBottom: 0, paddingRight: 8, width: 0, height: 200)
